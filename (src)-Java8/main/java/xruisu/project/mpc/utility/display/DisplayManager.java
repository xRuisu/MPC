...
public class DisplayManager extends FXMLVariables {
    ...
    public void importFonts() {
        ...
        Font fontOne = Font.loadFont(getClass().getResource("/assets/fonts/AntonFont.ttf").toExternalForm(), 15);
        Font fontTwo = Font.loadFont(getClass().getResource("/assets/fonts/GruppoFont.ttf").toExternalForm(), 15);
        Font fontThree = Font.loadFont(getClass().getResource("/assets/fonts/MPlusFont.ttf").toExternalForm(), 15);
