                ...
                try {
                        for (Node node : employeeListPane.getChildren()) {
                                if (node instanceof TextField) {
                                        TextField employeeTextField = (TextField) node;
                                        ...
                                        employeeTextField.setOnAction(actionEvent -> {
                                                if (!employeeTextField.getText().isEmpty()
                                                        ...
                                                        for (int i = 0; i < employeeFields.size(); i++) {
                                                                ...
                                                                DataManager.getEmp()
                                                                                .add(employeeField.getText().trim());
        ...
        private void handleScanFields() {
                try {
                        for (Node node : scanListPane.getChildren()) {
                                if (node instanceof TextField) {
                                        TextField scansTextField = (TextField) node;
        ...
        private void handleEmptyFields() {
                ...
                try {
                        for (int i = DataManager.getRate().size(); i < rateLabels.size(); i++) {
                                if (rateLabels.get(i).getText().isEmpty()
                                                || scanFields.get(i).getText().isEmpty()
                                                || employeeFields.get(i).getText().isEmpty()
                                                || valueLabels.get(i).getText().isEmpty()) {
