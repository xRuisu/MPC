...
public class ReportController {
    ...
    private void setHeaderStyles() {
        String headerStyle = "-fx-background-color: #1f1f1f; -fx-text-fill:"
    ...
    private void handle() {
        ...
        firstField.setOnAction(actionEvent -> {
            ...
            String input = firstField.getText().toUpperCase();
        ...
        secondField.setOnAction(actionEvent -> {
            ...
            String input = secondField.getText().toUpperCase();
        ...
        thirdField.setOnAction(actionEvent -> {
            ...
            String input = thirdField.getText().toUpperCase();
    ...
    private void readMPCFile() {
        ...
        FileListener listener = new FileListener(null);
        ...
        String previousReport = builder.toString();
    ...
    private void setContent(String font, int fontSize, Color textColor, Color backgroundColor,
        ...
        String currentReport = DataManager.getReport().toString();
        String previousReport = DataManager.getPrevious().toString();
        String blankContent = ReportFormatting.getEmptyContent();
